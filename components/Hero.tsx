  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black pt-16 sm:pt-20">
      ...
      <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto py-8 sm:py-12">
        ...
        <motion.div
          className="hidden sm:grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 justify-center items-stretch max-w-2xl mx-auto px-4"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          ...
          {BRANCH_PHONE_CONTACTS.map((branch) => (
            <Fragment key={branch.id}>
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="group relative w-full px-5 sm:px-6 lg:px-8 py-3.5 sm:py-4 bg-gradient-to-r from-pizza-red to-pizza-red-dark text-white rounded-full font-semibold text-sm sm:text-base shadow-2xl overflow-hidden transition-all duration-300 text-center"
              >
                <span className="relative z-10 flex flex-col items-center justify-center gap-0.5">
                  ...
                  <span className="text-xs font-medium opacity-90">{branch.landline.display}</span>
                </span>
                <div className="absolute inset-0 bg-gradient-to-r from-pizza-red-dark to-pizza-red opacity-0 group-hover:opacity-100 transition-opacity duration-300" aria-hidden />
              </motion.a>
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.05, y: -5 }}
                whileTap={{ scale: 0.95 }}
                className="group relative w-full px-5 sm:px-6 lg:px-8 py-3.5 sm:py-4 bg-gradient-to-r from-whatsapp to-whatsapp-dark text-white rounded-full font-semibold text-sm sm:text-base shadow-2xl overflow-hidden transition-all duration-300 text-center"
              >
                <span className="relative z-10 flex flex-col items-center justify-center gap-0.5">
                  <span className="flex items-center justify-center gap-2">
                  ...
                  <span className="text-xs font-medium opacity-90">{branch.mobile.display}</span>
                </span>
              </motion.a>
            </Fragment>
          ))}
